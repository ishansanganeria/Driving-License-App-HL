...
async function fetchOfficerDetails(uid) {
...
async function fetchScoresToBeAdded(rtoid) {
...
async function addScore(uid, testtype, score, officerid) {
   console.log("\n**********************************************addScore\n\n");
   ...
   try {
      ...
      var request = {
         chaincodeId: 'fabdl',
         fcn: 'AddTestResult',
         args: [uid, testtype, score, officerid, date, time],
         chainId: 'channeldl',
         txId: tx_id
      };
...
async function addTicket(uid, officerid, reason, place, amount) {
   console.log("\n**********************************************addTicket\n\n");
   ...
   try {
      ...
      var request = {
         chaincodeId: 'fabdl',
         fcn: 'AddTicket',
         args: [uid, officerid, reason, place, date, time, amount],
         chainId: 'channeldl',
         txId: tx_id
      };
...
async function payFine(uid, ticketid) {
   console.log("\n**********************************************payFine\n\n");
